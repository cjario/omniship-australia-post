 ...
 *
 */
class DomesticCarrier extends AbstractCarrier
{

    public function getName()
    {
        return 'Australia Post (Domestic)';
    }
    ...
    {
        return $this->createRequest('\Omniship\AustraliaPost\Message\Domestic\AustraliaPostBoxRequest', $parameters);
    }

    public function service(array $parameters = [])
    {
        return $this->createRequest('\Omniship\AustraliaPost\Message\Domestic\AustraliaPostServiceRequest', $parameters);
    }

    public function postage(array $parameters = [])
    {
        return $this->createRequest('\Omniship\AustraliaPost\Message\Domestic\AustraliaPostPostageRequest', $parameters);
    }
}
